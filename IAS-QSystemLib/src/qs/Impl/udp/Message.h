 ...
 */
#ifndef _IAS_QS_UDP_Message_H_
#define _IAS_QS_UDP_Message_H_
...
public:
	...
	void write(Buffer& buffer, size_t &iDataLen, const String& strTopic);

protected:
	Message();
	Message(const char* pData, size_t iDataLen, QS::Base::Attributes* pAttributes);
