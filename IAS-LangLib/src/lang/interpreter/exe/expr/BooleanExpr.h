/*
 * File: IAS-LangLib/src/lang/interpreter/exe/expr/BooleanExpr.h
 *
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Exe_Expr_BOOLEANEXPR_H_
#define _IAS_AS_Lang_Interpreter_Exe_Expr_BOOLEANEXPR_H_
...
/*************************************************************************/
/** The class. */
 class BooleanExpr : public virtual Expr {
public:

	virtual ~BooleanExpr() throw();
...
protected:
	...
	friend class ::IAS::Factory<BooleanExpr>;
};
