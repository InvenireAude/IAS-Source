...
/*************************************************************************/
IAS::DM::DataObject* Type::createDataObject(const IAS::Decimal& aValue) const{
	IAS_TRACER;
	IAS_LOG(IAS::DM::LogLevel::INSTANCE.isInfo(),"createDataObject: "<<aValue.toString());
	Type::PtrHolder ptrObj(createDataObjectImpl());
	ptrObj->setDecimal(aValue);
	return ptrObj.pass();
}
/*************************************************************************/
