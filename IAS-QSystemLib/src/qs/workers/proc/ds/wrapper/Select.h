...
protected:
  ...
  String parseColumnNameOrExpr(Lexer* pLexer);
  ...
  void parseGroupBy(Lexer *pLexer);
  void parseOrderBy(Lexer *pLexer);
  void parseOrderByMap(Lexer *pLexer, DM::DataObject* dm);
  String parseOrderByText(Lexer *pLexer);
