/*
 * File: IAS-LangLib/src/lang/interpreter/exe/expr/DecimalExpr.h
 *
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Exe_Expr_DecimalEXPR_H_
#define _IAS_AS_Lang_Interpreter_Exe_Expr_DecimalEXPR_H_
...
/*************************************************************************/
/** The class. */
 class DecimalExpr : public virtual Expr {
public:

	virtual ~DecimalExpr() throw();
...
protected:
	...
	friend class ::IAS::Factory<DecimalExpr>;
};
