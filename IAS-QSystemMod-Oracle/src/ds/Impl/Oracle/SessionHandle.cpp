 ...
 *
 * File: IAS-QSystemMod-Oracle/src/ds/Impl/Oracle/SessionHandle.cpp 
 *
...
/*************************************************************************/
SessionHandle::SessionHandle(OCIEnv* pOCIEnv):pOCIEnv(pOCIEnv){
	IAS_TRACER;
	hError.initialize(pOCIEnv);
}
/*************************************************************************/
SessionHandle::~SessionHandle() throw(){
	IAS_TRACER;
}
/*************************************************************************/
}
