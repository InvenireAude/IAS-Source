/*
 * File: IAS-QSystemLib/src/qs/Impl/sdf/Session.cpp
 * 
...
API::Controller*  Session::createController(const API::Destination& refDestination){
	IAS_TRACER;
	IAS_THROW(BadUsageException("There is no controller yet for Files/Directories."));
}
/*************************************************************************/
...
API::Requester*  Session::createRequester(const API::Destination& outDestination,
	...
	IAS_TRACER;
	IAS_THROW(BadUsageException("Requester not supported in File/Directory transport."));
}
/*************************************************************************/
