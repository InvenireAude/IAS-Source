/*
 * File: IAS-DataModelLib/src/dm/Impl/DataObjectInteger.h
 *
 ...
 */
#ifndef _IAS_DM_Impl_DATAOBJECTINTEGER_H_
#define _IAS_DM_Impl_DATAOBJECTINTEGER_H_
...
/*************************************************************************/
class DataObjectInteger : public ::IAS::DM::Impl::DataObjectBasic {
public:

	virtual ~DataObjectInteger() throw();
...
protected:
	DataObjectInteger(const Type *pType);


	long iValue;

	friend class ::IAS::Factory<DataObjectInteger>;
};
