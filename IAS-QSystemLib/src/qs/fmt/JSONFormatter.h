/*
 * File: IAS-QSystemLib/src/qs/fmt/JSONFormatter.h
 *
 ...
 */
#ifndef _IAS_QS_Fmt_JSONFormatter_H_
#define _IAS_QS_Fmt_JSONFormatter_H_
...
protected:
	JSONFormatter(const DM::DataFactory* pDataFactory);
	...
	friend class Factory<JSONFormatter>;
};
...
#endif /* _IAS_QS_Fmt_JSONFormatter_H_ */
