...
BEGIN
 ...
 VAR shadow AS Customer : "http://www.invenireaude.org/example";

 shadow = input;
 shadow.address[1].street = "cien";

 VAR test AS Address:"http://www.invenireaude.org/example";
 ...
 WHILE i>0 DO
  BEGIN
    ...
    BEGIN
        VAR aa AS Address:"http://www.invenireaude.org/examplef";
    	aa = NEW Address : "http://www.invenireaude.org/examplef";
  ...
  END;
   ...
   VAR a1 AS Address:"http://www.invenireaude.org/examplef";
   VAR a2 AS Address:"http://www.invenireaude.org/examplef";
   VAR a3 AS Address:"http://www.invenireaude.org/examplef";
   ...
   VAR nowy AS Address:"http://www.invenireaude.org/example";
 ...
 END
   CATCH (VAR e AS Integer )BEGIN
   	input.age = p1;
   END
   CATCH (VAR a AS Customer:"http://www.invenireaude.org/example" )BEGIN
   	input = a;
   END;
