...
/*************************************************************************/
Connection::Connection(UDP::System* pSystem,
...
API::Session* Connection::createSession(API::Session::TransactionMode iMode){
	...
	switch(iMode){
		...
		case API::Session::SM_Transacted:
			return IAS_DFT_FACTORY<QS::UDP::SessionTransacted>::Create(this);

		case API::Session::SM_NonTransacted:
			return IAS_DFT_FACTORY<QS::UDP::SessionAutoCommit>::Create(this);
...
API::Message* Connection::createMessage(){
	IAS_TRACER;
	return IAS_DFT_FACTORY< QS::UDP::Message >::Create();
}
/*************************************************************************/
...
/*************************************************************************/
UDP::System* Connection::getSystem(){
	IAS_TRACER;
	return pSystem;
}
/*************************************************************************/
