/*
 * File: IAS-QSystemLib/src/qs/Impl/sdf/SessionTransacted.h
 * 
 ...
 */
#ifndef _IAS_QS_UDP_SessionTransacted_H_
#define _IAS_QS_UDP_SessionTransacted_H_
...
#endif /* _IAS_QS_UDP_SessionTransacted_H_ */
