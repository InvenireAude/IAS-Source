/*
 * File: IAS-DataModelLib/src/dm/Impl/DataObjectTime.h
 *
 ...
 */
#ifndef _IAS_DM_Impl_DATAOBJECTTIME_H_
#define _IAS_DM_Impl_DATAOBJECTTIME_H_
...
/*************************************************************************/
class DataObjectTime : public ::IAS::DM::Impl::DataObjectBasic {
public:

	virtual ~DataObjectTime() throw();
...
protected:
	DataObjectTime(const Type *pType);


	IAS::Time tValue;

	friend class ::IAS::Factory<DataObjectTime>;
};
