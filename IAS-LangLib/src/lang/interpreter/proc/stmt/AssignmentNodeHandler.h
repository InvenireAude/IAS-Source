/*
 * File: IAS-LangLib/src/lang/interpreter/proc/stmt/AssignmentNodeHandler.h
 *
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Proc_Stmt_AssignmentNodeHandler_H_
#define _IAS_AS_Lang_Interpreter_Proc_Stmt_AssignmentNodeHandler_H_
...
public:
	...
	virtual ~AssignmentNodeHandler() throw();
...
protected:
	...
	friend class ::IAS::Factory<AssignmentNodeHandler>;
};
