/*
 * File: IAS-LangLib/src/lang/interpreter/proc/expr/RelationalGtNodeHandler.cpp
 *
...
void RelationalGtNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, CallbackSignature::Result& aResult){
	...
	CallbackRegister::SubCall(pGtNode->getLeftExpr(),pCtx,aResultLeft);
	IAS_DFT_FACTORY<Exe::Expr::Expr>::PtrHolder ptrExprLeft(aResultLeft.pExpr);

	CallbackSignature::Result aResultRight;
	CallbackRegister::SubCall(pGtNode->getRightExpr(),pCtx,aResultRight);
