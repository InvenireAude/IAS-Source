/*
 * File: IAS-DataModelLib/src/dm/Impl/DataObjectDecimal.h
 *
 ...
 */
#ifndef _IAS_DM_Impl_DATAOBJECTDECIMAL_H_
#define _IAS_DM_Impl_DATAOBJECTDECIMAL_H_
...
/*************************************************************************/
class DataObjectDecimal : public ::IAS::DM::Impl::DataObjectBasic {
public:

	virtual ~DataObjectDecimal() throw();
...
protected:
	DataObjectDecimal(const Type *pType);


	Decimal aValue;

	friend class ::IAS::Factory<DataObjectDecimal>;
};
