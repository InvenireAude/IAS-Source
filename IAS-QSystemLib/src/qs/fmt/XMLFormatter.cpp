...
const String& XMLFormatter::CDateTimeFormatOut("."+DM::XML::XMLHelper::CEnvDateTimeFormatOut);
...
void XMLFormatter::write(const DM::DataObject* dmData,
	...
	if(pAttributes){
		...
		if(pAttributes->isSet(CDateTimeFormatOut))
			ptrXMLHelper->setDateTimeFormatOut(pAttributes->getValue(CDateTimeFormatOut));
