/*
 * File: IAS-LangLib/src/lang/interpreter/exe/expr/DateTimeExpr.h
 *
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Exe_Expr_DateTimeExpr_H_
#define _IAS_AS_Lang_Interpreter_Exe_Expr_DateTimeExpr_H_
...
/*************************************************************************/
/** The class. */
 class DateTimeExpr : public virtual Expr {
public:

	virtual ~DateTimeExpr() throw();
...
protected:
	...
	friend class ::IAS::Factory<DateTimeExpr>;
};
