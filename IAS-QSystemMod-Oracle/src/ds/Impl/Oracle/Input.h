 ...
 *
 * File: IAS-QSystemMod-Oracle/src/ds/Impl/Oracle/Input.h
 *
 ...
 *
 */
#ifndef _IAS_DS_Impl_Oracle_Input_H_
#define _IAS_DS_Impl_Oracle_Input_H_
...
#endif /* _IAS_DS_Impl_Oracle_Input_H_ */
