 ...
 *
 * File: IAS-QSystemMod-Oracle/src/ds/Impl/Oracle/Connection.cpp 
 *
...
/*************************************************************************/
Connection::Connection(Oracle::System* pSystem,
...
API::Session* Connection::createSession(API::Session::TransactionMode iMode){
	...
	switch(iMode){
		...
		case API::Session::SM_Transacted:
			return IAS_DFT_FACTORY<Oracle::SessionTransacted>::Create(this);

		case API::Session::SM_NonTransacted:
			return IAS_DFT_FACTORY<Oracle::SessionAutoCommit>::Create(this);

		case API::Session::SM_XAManaged:
			return IAS_DFT_FACTORY<Oracle::SessionXAManaged>::Create(this);
...
/*************************************************************************/
Oracle::System* Connection::getSystem(){
	IAS_TRACER;
	return pSystem;
}
/*************************************************************************/
