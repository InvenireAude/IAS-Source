/*
 * File: IAS-LangLib/src/lang/interpreter/exe/expr/TimeExpr.h
 *
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Exe_Expr_TimeExpr_H_
#define _IAS_AS_Lang_Interpreter_Exe_Expr_TimeExpr_H_
...
/*************************************************************************/
/** The class. */
 class TimeExpr : public virtual Expr {
public:

	virtual ~TimeExpr() throw();
...
protected:
	...
	friend class ::IAS::Factory<TimeExpr>;
};
