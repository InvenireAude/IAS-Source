 ...
 */
#ifndef _IAS_QS_UDP_Connection_H_
#define _IAS_QS_UDP_Connection_H_
...
public:
	...
	UDP::System *getSystem();

  const ::org::invenireaude::qsystem::workers::Connection* getConfiguration() const{
    return dmConnection;
  }

protected:
	Connection(UDP::System* pSystem, const ::org::invenireaude::qsystem::workers::Connection* dmConnection);

	friend class Factory<Connection>;

	String strName;
  const ::org::invenireaude::qsystem::workers::Ext::ConnectionPtr dmConnection;
...
#endif /* _IAS_QS_UDP_Connection_H_ */
