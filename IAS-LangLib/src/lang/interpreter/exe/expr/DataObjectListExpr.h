/*
 * File: IAS-LangLib/src/lang/interpreter/exe/expr/DataObjectListExpr.h
 *
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Exe_Expr_DataObjectListExpr_H_
#define _IAS_AS_Lang_Interpreter_Exe_Expr_DataObjectListExpr_H_
...
/*************************************************************************/
/** The class to overload evaluteX methods for list expressions.          */
 class DataObjectListExpr :
	public virtual Expr {
public:

	virtual ~DataObjectListExpr() throw();
