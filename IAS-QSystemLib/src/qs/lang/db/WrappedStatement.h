/*
 * File: IAS-QSystemLib/src/qs/lang/db/WrappedStatement.h
 *
 ...
 */
#ifndef _IAS_QS_Lang_DB_WrappedStatement_H_
#define _IAS_QS_Lang_DB_WrappedStatement_H_
 ...
 *
 */
class WrappedStatement : public ::IAS::Lang::Interpreter::Extern::Statement {
public:
...
protected:
	...
	WrappedStatement(const DM::Type* pType, const StringList& lstParamaters, const ::IAS::Lang::Interpreter::Extern::ModuleProxy* pModuleProxy);
...
#endif /* _IAS_Lang_Interpreter_Extern_Std_WrappedStatement_H_ */
