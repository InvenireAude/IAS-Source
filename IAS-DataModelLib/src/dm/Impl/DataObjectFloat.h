 ...
 */
#ifndef _IAS_DM_Impl_DATAOBJECTFLOAT_H_
#define _IAS_DM_Impl_DATAOBJECTFLOAT_H_
...
/*************************************************************************/
class DataObjectFloat : public ::IAS::DM::Impl::DataObjectBasic {
public:

	virtual ~DataObjectFloat() throw();
...
protected:
	...
	friend class ::IAS::Factory<DataObjectFloat>;
};
