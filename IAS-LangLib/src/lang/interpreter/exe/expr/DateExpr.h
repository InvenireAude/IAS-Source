/*
 * File: IAS-LangLib/src/lang/interpreter/exe/expr/DateExpr.h
 *
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Exe_Expr_DateExpr_H_
#define _IAS_AS_Lang_Interpreter_Exe_Expr_DateExpr_H_
...
/*************************************************************************/
/** The class. */
 class DateExpr : public virtual Expr {
public:

	virtual ~DateExpr() throw();
...
protected:
	...
	friend class ::IAS::Factory<DateExpr>;
};
